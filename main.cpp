...
/*Se crea un arreglo por cada área delimitando el espacio disponible por cada una,
en este caso se asignaron 10*/
Casa Dato1[10];
Consulta Dato2[10];
Covid Dato3[10];

/*Variables para acceder al espacio de memoria del arreglo y llevar 
un conteo de los espacios disponibles por cada área*/
int auxa=0;
int auxb=0;
int auxc=0;
int aux1=10;
